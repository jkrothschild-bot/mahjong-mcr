...
// one exists (the 34 standard types, generated by
// scripts/generate-tile-art.mjs from a CC0 source — see
// tiles/vendor/riichi-mahjong-tiles/NOTICE.md); flowers/seasons have no art
// in that source (tileImages.ts's known gap) but still get a real, distinct
// face via FlowerTileFace rather than plain text.
//
