...
describe('Melds', () => {
  it('renders nothing when there are no melds', () => {
    const { container } = render(<Melds seat={0} melds={[]} region={TEST_REGION} />)
  ...
  it('renders every tile in a meld face-up, including a concealed kong', () => {
    ...
    render(<Melds seat={0} melds={[meld]} region={TEST_REGION} />)
  ...
  it('highlights meld tiles matching the selected type', () => {
    ...
    render(<Melds seat={0} melds={[meld]} region={TEST_REGION} selectedTypeId="B5" />)
  ...
  it('calls onTileClick with the clicked tile id', () => {
    ...
    render(<Melds seat={0} melds={[meld]} region={TEST_REGION} onTileClick={onTileClick} />)
